...
function addOnlineBadge(){
  ...
  style.textContent=`
    ...
    .noctra-online-badge.is-reader{position:absolute;left:12px;top:88px;right:auto;bottom:auto}
    .noctra-online-dot{width:8px;height:8px;border-radius:50%;background:#35d06f;box-shadow:0 0 9px rgba(53,208,111,.85)}
    @media(max-width:700px){.noctra-online-badge{right:8px;bottom:8px;padding:6px 9px;font-size:10px}.noctra-online-badge.is-reader{position:absolute;left:8px;top:72px;right:auto;bottom:auto}}
  `;
